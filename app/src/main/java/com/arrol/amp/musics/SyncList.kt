        ...
        when (sortMode) {
            SortMode.Name -> {
                if (listContent == ListContent.ListOfMusics)
                    list =
                        ArrayList(list.sortedWith(compareBy(String.CASE_INSENSITIVE_ORDER) { smc.getMusic(it).title.toString() }))
            ...
            SortMode.NameR -> {
                if (listContent == ListContent.ListOfMusics)
                    list =
                        ArrayList(list.sortedWith(compareByDescending(String.CASE_INSENSITIVE_ORDER) { smc.getMusic(it).title.toString() }))
                else if (listContent == ListContent.ListOfLists)
                    list =
                        ArrayList(list.sortedWith(compareByDescending(String.CASE_INSENSITIVE_ORDER) { smc.getList(it).name }))
            }
            SortMode.Date -> {
